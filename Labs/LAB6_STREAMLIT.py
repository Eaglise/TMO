...
def load_data():
    ...
    Загрузка данных
    '''
    data = pd.read_csv('data/air_satisfaction.csv')
...
def preprocess_data(data_in):
    ...
    X_train, X_test, y_train, y_test = train_test_split(data_out[new_cols], data_out['satisfaction'], train_size=0.8, random_state=1)
...
disp = ConfusionMatrixDisplay(confusion_matrix=cm, display_labels=['Neural or dissatisfied', 'Satisfied'])
